...
namespace Otel_Rezervasyon_Sistemi
{
    public partial class Form10 : Form
    {
        ...
        {
            button3.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_41.Text, numericUpDown10, dateTimePicker20, dateTimePicker19);
            button3.Click += HotelButton_Click;

            button5.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_42.Text, numericUpDown9, dateTimePicker18, dateTimePicker17);
            button5.Click += HotelButton_Click;

            button7.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_43.Text, numericUpDown8, dateTimePicker16, dateTimePicker15);
            button7.Click += HotelButton_Click;

            button6.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_44.Text, numericUpDown7, dateTimePicker14, dateTimePicker13);
            button6.Click += HotelButton_Click;

            button9.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_45.Text, numericUpDown6, dateTimePicker12, dateTimePicker11);
            button9.Click += HotelButton_Click;

            button8.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_46.Text, numericUpDown5, dateTimePicker10, dateTimePicker9);
            button8.Click += HotelButton_Click;

            button11.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_47.Text, numericUpDown4, dateTimePicker8, dateTimePicker7);
            button11.Click += HotelButton_Click;

            button10.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_48.Text, numericUpDown3, dateTimePicker6, dateTimePicker5);
            button10.Click += HotelButton_Click;

            button4.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_49.Text, numericUpDown2, dateTimePicker4, dateTimePicker3);
            button4.Click += HotelButton_Click;

            button2.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_50.Text, numericUpDown1, dateTimePicker1, dateTimePicker2);
