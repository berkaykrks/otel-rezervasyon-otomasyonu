...
namespace Otel_Rezervasyon_Sistemi
{
    public partial class Form7 : Form
    {
        ...
        // Tüm butonlar için aynı tıklama olayı
        ...
        {
            button3.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_11.Text, numericUpDown10, dateTimePicker20, dateTimePicker19);
            button3.Click += HotelButton_Click;

            button4.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_12.Text, numericUpDown9, dateTimePicker18, dateTimePicker17);
            button4.Click += HotelButton_Click;

            button5.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_13.Text, numericUpDown8, dateTimePicker16, dateTimePicker15);
            button5.Click += HotelButton_Click;

            button9.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_14.Text, numericUpDown7, dateTimePicker14, dateTimePicker13);
            button9.Click += HotelButton_Click;

            button8.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_15.Text, numericUpDown6, dateTimePicker12, dateTimePicker11);
            button8.Click += HotelButton_Click;

            button7.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_16.Text, numericUpDown5, dateTimePicker10, dateTimePicker9);
            button7.Click += HotelButton_Click;

            button11.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_17.Text, numericUpDown4, dateTimePicker8, dateTimePicker7);
            button11.Click += HotelButton_Click;

            button10.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_18.Text, numericUpDown3, dateTimePicker6, dateTimePicker5);
            button10.Click += HotelButton_Click;

            button6.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_19.Text, numericUpDown2, dateTimePicker4, dateTimePicker3);
            button6.Click += HotelButton_Click;

            button2.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_20.Text, numericUpDown1, dateTimePicker2, dateTimePicker1);
