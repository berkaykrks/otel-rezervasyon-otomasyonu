...
namespace Otel_Rezervasyon_Sistemi
{
    public partial class Form6 : Form
    {
        ...
        {
            button3.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_1.Text, numericUpDown1, dateTimePicker1, dateTimePicker2);
            button3.Click += HotelButton_Click;

            button2.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_2.Text, numericUpDown2, dateTimePicker4, dateTimePicker3);
            button2.Click += HotelButton_Click;

            button5.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_3.Text, numericUpDown3, dateTimePicker6, dateTimePicker5);
            button5.Click += HotelButton_Click;

            button6.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_4.Text, numericUpDown4, dateTimePicker8, dateTimePicker7);
            button6.Click += HotelButton_Click;

            button7.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_5.Text, numericUpDown5, dateTimePicker10, dateTimePicker9);
            button7.Click += HotelButton_Click;

            button8.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_6.Text, numericUpDown6, dateTimePicker12, dateTimePicker11);
            button8.Click += HotelButton_Click;

            button9.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_7.Text, numericUpDown7, dateTimePicker14, dateTimePicker13);
            button9.Click += HotelButton_Click;

            button10.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_8.Text, numericUpDown8, dateTimePicker16, dateTimePicker15);
            button10.Click += HotelButton_Click;

            button11.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_9.Text, numericUpDown9, dateTimePicker18, dateTimePicker17);
            button11.Click += HotelButton_Click;

            button4.Tag = new Tuple<string, NumericUpDown, DateTimePicker, DateTimePicker>(hotelName_10.Text, numericUpDown10, dateTimePicker20, dateTimePicker19);
